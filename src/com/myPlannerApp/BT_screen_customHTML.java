...
public class BT_screen_customHTML extends BT_activity_base{
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        this.activityName = "BT_screen_customHTML";
		...
		View thisScreensView = vi.inflate(R.layout.screen_customhtml, null);
	...
	public void emailDocument(){
		...
		if(myPlannerApp_appDelegate.rootApp.getRootDevice().canSendEmail() && BT_fileManager.doesCachedFileExist(saveAsFileName)){
			...
			BT_activity_base.showAlertFromClass(myPlannerApp_appDelegate.getApplication().getString(R.string.errorTitle), getString(R.string.cannotEmailDocument));

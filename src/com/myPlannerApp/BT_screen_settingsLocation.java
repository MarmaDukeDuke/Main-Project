					...
					public void onClick(View v) {
    					...
    					//update allow / prevent userAllowLocation preference...
    	           		if(theText.equalsIgnoreCase(getString(R.string.settingsAllowGPS))){
    	           			...
    	           			myPlannerApp_appDelegate.foundUpdatedLocation = false;
    	           		}
    	           		if(theText.equalsIgnoreCase(getString(R.string.settingsPreventGPS))){
    	           			BT_strings.setPrefString("userAllowLocation", "prevent");
    	           			myPlannerApp_appDelegate.rootApp.getRootDevice().setDeviceLatitude("0");
    	           			myPlannerApp_appDelegate.rootApp.getRootDevice().setDeviceLongitude("0");
    	           			myPlannerApp_appDelegate.rootApp.getRootDevice().setDeviceAccuracy("0");

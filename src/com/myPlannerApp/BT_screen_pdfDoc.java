	...
	public void emailDocument(){
		...
		if(myPlannerApp_appDelegate.rootApp.getRootDevice().canSendEmail() && BT_fileManager.doesCachedFileExist(saveAsFileName)){
			...
			try{
	            ...
	            File file = new File(myPlannerApp_appDelegate.getApplication().getExternalCacheDir(), saveAsFileName);
			...
			BT_activity_base.showAlertFromClass(myPlannerApp_appDelegate.getApplication().getString(R.string.errorTitle), getString(R.string.fileNotDownloadedYet));

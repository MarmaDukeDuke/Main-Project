...
public class BT_screen_settingsDevice extends BT_activity_base{
	...
	private List<ChildItemsDataModel> getModel() {
		...
		//device model
		String modelInfo = getString(R.string.deviceModel) + ": " + myPlannerApp_appDelegate.rootApp.getRootDevice().getDeviceModel();
   		list.add(getChildItem(modelInfo));
	    		
   		//device screen size
		String screenInfo = getString(R.string.deviceResolution) + ": " + myPlannerApp_appDelegate.rootApp.getRootDevice().getDeviceWidth() + " x " + myPlannerApp_appDelegate.rootApp.getRootDevice().getDeviceHeight();
		...
		String cacheSize = getString(R.string.deviceCacheSize) + ": " + BT_strings.formatBytes(size, true);
 		...
 		//device can take pictures
   		...
   		if(myPlannerApp_appDelegate.rootApp.getRootDevice().canTakePictures()){
		...
		//device GPS capable
   		...
   		if(myPlannerApp_appDelegate.rootApp.getRootDevice().canUseGPS()){
    ...
    public void clearCache(){
    	...
    	//remove cached data....
    	BT_fileManager.deleteAllCachedData(myPlannerApp_appDelegate.configurationFileName);
